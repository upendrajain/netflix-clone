...
export default function Footer() {
  return (
    <div className=' container mx-auto max-w-6xl lg:py-20 md:py-20 py-10 px-5'>
      ...
      <div className="text-gray-300 flex flex-wrap lg:flex-nowrap justify-between mb-4 cursor-pointer">
        <div className="one w-full lg:w-auto mb-5 lg:mb-0">
        ...
        <div className="two w-full lg:w-auto mb-5 lg:mb-0">
          <ul className='underline'>
        ...
        <div className="three w-full lg:w-auto mb-5 lg:mb-0">
          <ul className='underline'>
        ...
        <div className="four w-full lg:w-auto mb-5 lg:mb-0">
          <ul className='underline'>
