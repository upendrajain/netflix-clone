  ...
  return (
    ...
    <div className='main flex lg:flex-nowrap md:flex-nowrap sm:flex-wrap flex-wrap  justify-evenly items-center lg:py-20 md:py-20 py-10 px-5'>
        ...
        <div className="left mb-10 lg:mb-0 md:mb-0 sm:mb-0">
            ...
            <p className='text-white lg:text-2xl md:text-2xl text-center text-lg lg:text-start md:text-start sm:text-start'>Stream unlimited movies and TV shows on your <br className=' hidden lg:block md:block' /> phone, tablet, laptop, and TV.</p>
        </div>
        {/* right */}
        <div className="right">
